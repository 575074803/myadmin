<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:66:"E:\wampserver\wamp64\www\myadmin/app/admin\view\message\index.html";i:1515570965;}*/ ?>
<!DOCTYPE html>
<html>
<head>
                        ...
                        <table class="table table-striped table-bordered table-hover dataTables-example">
                            ...
                            <tbody>
                                ...
                                <tr id="data<?php echo $vo['id']; ?>" class="gradeX">
                                    ...
                                    <td class="center">
										<a href="<?php echo url('edit',array('id'=>$vo['id'])); ?>"  class=" btn btn-primary btn-sm">回复</a>
