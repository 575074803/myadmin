<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:66:"E:\wampserver\wamp64\www\myadmin/app/admin\view\category\cate.html";i:1516326324;}*/ ?>
<?php
use think\Db;
?>
<!DOCTYPE html>
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
						<div class="">
                            <a href="<?php echo url('cate_add'); ?>"  class="layui-btn layui-btn-sm">添加类别</a>
                        </div>
                        <table class="layui-table" lay-size="sm">
						  ...
						  <tbody>
								...
								{
									$row=Db::name('weblinktype')->where('parentid',$id)->order('orderid asc')->select();
									foreach($row as $vo){
								?>
