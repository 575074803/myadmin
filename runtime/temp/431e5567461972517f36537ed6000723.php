<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:64:"E:\wampserver\wamp64\www\myadmin/app/admin\view\wechat\menu.html";i:1516070571;}*/ ?>
<?php
use think\Db;
?>
<!DOCTYPE html>
...
<body class="gray-bg">
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
						<div class="">
                            <a href="<?php echo url('menu_add'); ?>"  class="layui-btn layui-btn-sm">添加菜单</a>
                            
                            <a href="<?php echo url('menu_create'); ?>"  class="layui-btn layui-btn-sm">生成菜单</a>
                        </div>
                        <table class="layui-table" lay-size="sm">
						  ...
						  <tbody>
                                ...
                                <tr  id="data<?php echo $vo['id'];?>">
									...
									<td>
										<a href="<?php echo url('menu_edit',array('id'=>$vo['id'])); ?>"  class="layui-btn layui-btn-xs">修改</a>
	...
	<script>
		$('.demo3').click(function () {
			...
			if(confirm("确定删除此栏目吗？"))
			{
				$.post("<?php echo url('admin/wechat/menu_del');?>",{tablename:"<?php echo $tablename; ?>",id:authid,whereid:'id'}, function (data) {
					if(data.status == 200){
						//alert(data.msg);
