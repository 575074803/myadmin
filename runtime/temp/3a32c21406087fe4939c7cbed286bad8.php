<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"E:\wampserver\wamp64\www\myadmin/app/admin\view\users\user_group.html";i:1515570115;}*/ ?>
<!DOCTYPE html>
<html>
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
						<div class="">
                            <a href="<?php echo url('users/group_add'); ?>"  class=" btn btn-primary ">添加会员组</a>
                        </div>
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr  id="data<?php echo $vo['id']; ?>">
                                    ...
                                    <td><?php echo $vo['bomlimit']; ?>-<?php echo $vo['toplimit']; ?></td>
                                    <td>
										...
										<a onclick="ajaxSort('member_level',<?php echo $vo['id']; ?>);">更新</a>
                                    </td>
                                   
									<td>
									<a href="<?php echo url('users/groupEdit',array('id'=>$vo['id'])); ?>"   class=" btn btn-primary btn-sm">修改</a>
    ...
    <script>
        $('.demo3').click(function () {
			...
			swal({
				...
				$.post("<?php echo url('users/group_del'); ?>", {id:authid}, function (data) {
					if(data.status == 200){
