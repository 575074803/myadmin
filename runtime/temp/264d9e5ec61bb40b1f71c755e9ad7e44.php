<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:63:"E:\wampserver\wamp64\www\myadmin/app/admin\view\link\index.html";i:1515571297;}*/ ?>
<!DOCTYPE html>
<html>
<head>
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
						<div class="">
                            <a href="<?php echo url('add'); ?>"  class=" btn btn-primary ">友情链接添加</a>
                        </div>
                        <table class="table table-striped table-bordered table-hover dataTables-example">
                            ...
                            <tbody>
                                ...
                                <tr id="data<?php echo $vo['id']; ?>" class="gradeX">
                                    ...
                                    <td><?php echo $vo['webname']; ?></td>
                                    <td><?php echo $vo['linkurl']; ?></td>
                                    <td><?php echo getClassName("weblinktype",$vo['classid'] ,"classname"); ?></td>
                                    <td>
                                    ...
                                    <td class="center">
										<a href="<?php echo url('admin/link/edit',array('id'=>$vo['id'])); ?>"  class=" btn btn-primary btn-sm">修改</a>
