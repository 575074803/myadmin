<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:63:"E:\wampserver\wamp64\www\myadmin/app/admin\view\wechat\img.html";i:1516086282;}*/ ?>
<?php
use think\Db;
?>
<!DOCTYPE html>
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
						<div class="">
                            <a href="<?php echo url('img_add'); ?>"  class="layui-btn layui-btn-sm">添加图文</a>
                        </div>
                        <table class="layui-table" lay-size="sm">
						  ...
						  <tbody>
                                ...
                                <tr  id="data<?php echo $vo['id'];?>">
									...
									<td>
										<a href="<?php echo url('img_edit',array('id'=>$vo['id'])); ?>"  class="layui-btn layui-btn-xs">修改</a>
