<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:66:"E:\wampserver\wamp64\www\myadmin/app/admin\view\wechat\images.html";i:1516094898;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<body class="gray-bg">
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
						<div class="">
                            <a href="<?php echo url('images_add'); ?>"  class="layui-btn layui-btn-sm">添加多图文</a>
                        </div>
                        <table class="layui-table" lay-size="sm">
						  ...
						  <tbody>
                                ...
                                <tr  id="data<?php echo $vo['id'];?>">
									...
									<td><?php echo $vo['recon_num']; ?></td>
									<td>
										<a href="<?php echo url('images_list',array('id'=>$vo['id'])); ?>"  class="layui-btn layui-btn-xs">图文详情</a>
	...
	<script>
		$('.demo3').click(function () {
			...
			if(confirm("确定删除此栏目吗？"))
			{
				$.post("<?php echo url('admin/wechat/img_del');?>",{tablename:"<?php echo $tablename; ?>",id:authid,whereid:'id'}, function (data) {
					if(data.status == 200){
						//alert(data.msg);
