<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:67:"E:\wampserver\wamp64\www\myadmin/app/admin\view\auth\admin_add.html";i:1515562090;}*/ ?>
<?php
use think\Db;
?>
<!DOCTYPE html>
            ...
            <div class="col-sm-8">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form action="<?php echo url('auth/admin_add'); ?>" method="post" class="form-horizontal">
							...
							<div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input name="password" type="password" class="form-control" placeholder="请输入密码" minlength="6" required="">
                                </div>
                            </div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="radio i-checks">
									<label>
										<input type="radio" checked="" value="1" name="is_open"> <i></i> 开启
										<input type="radio"  value="0" name="is_open"> <i></i> 关闭
